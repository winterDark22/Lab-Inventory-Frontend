                  ...
                  <div className="bg-myBG px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div className="sm:flex sm:flex-col fle items-stretch">
                      <div className="my-3 text-center sm:mt-0 sm:ml-4 sm:text-left flex-grow">
                        <h3 className="text-lg leading-6 font-medium text-myText">
                          Comments
                        </h3>
                        ...
                        <div className="mt-4">
                          <textarea
                            ...
                            className="p-2 border rounded-lg text-sm w-full focus:outline-none focus:ring-1 focus:ring-pinky focus:border-transparent"
                          />
                        </div>
                        <div className="mt-4">
