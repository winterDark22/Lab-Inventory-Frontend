              ...
              allNotifications
                ...
                .map((notification, index) => (
                  <tr
                    ...
                    className={`border-b-[7px] border-b-myBG bg-myCard h-10 cursor-pointer pl-3 text-myText ${index < newNotificationCnt ? " bg-newNoti border-x-[7px] border-x-pinky shadow-md" : ""
                      }`}
                  >
                    <td className="p-2.5" >
